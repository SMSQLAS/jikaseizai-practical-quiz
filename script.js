...
const questions = [
  ...
  {
    text: `
<strong>問題1</strong><br>患者から錠剤の粉砕を希望されたため、薬剤師が疑義照会を行った。<br>処方医から粉砕の了承を得たうえで、薬学的に問題がないことを確認し、粉砕して調剤した。<br>※同一成分の散剤等は薬価基準に収載されていないものとする。<br><br>自家製剤加算を算定できるか？
`,
    answer: true,
    explanation: `
...
`
  ...
  {
    text: `
<strong>問題2</strong><br>次のいずれかの依頼だけで、医師への確認を行わずに錠剤を粉砕した。<br>・患者本人の希望<br>・家族の希望<br>・介護施設職員からの依頼<br>※同一成分の散剤等は薬価基準に収載されていないものとする。<br><br>自家製剤加算を算定できるか？
`,
    answer: false,
    explanation: `
...
`,
    answer: false,
    explanation: `
算定できません。<br>パリエット（一般名：ラベプラゾール）は胃酸で効き目が失われるのを防ぐため腸溶性コーティングが施されており、粉砕は不可です。
<br>粉砕すると薬が胃で壊れて効果がなくなりますので、代替案としてランソプラゾールOD錠（軽く砕くはOK）、エソメプラゾール懸濁用顆粒、タケキャブ（PPIではないが粉砕可）などに、疑義照会をして変更してもらうことが多いです。
...
`
    ...
    {
    text: `
<strong>問題12</strong><br>「クロチアゼパム錠5㎎「トーワ」　0.5錠　分1朝食後」を調剤。<br><br>自家製剤加算を算定できるか？
`,
    answer: false,
    explanation: `
算定できません。<br><br>クロチアゼパム錠5㎎「トーワ」は<strong>糖衣錠</strong>です。<br>
糖衣錠の分割は、分割後の含量均一性・安定性・溶出性等に影響する可能性があるため、薬学的に問題がないことを確認する必要があります。
<br>本剤では半錠時に薬学的に問題がないことを確認できる資料がないため、自家製剤加算は算定できません。
`
  },
  {
    text: `
...
`,
    answer: false,
    explanation: `
算定できません。バイアスピリン（腸溶錠）の粉砕は、アスピリン末が薬価収載されています。<br>アスピリン末の適応は解熱鎮痛と川崎病のみなので、適応が異なっていたら算定が出来ると思いがちですが、適応外でも算定はできません。
`
  },
  {
    text: `
